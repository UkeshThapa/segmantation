...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='nih_xrays_dataset',
    ...
    if args.epochs is None:
        epoches = {
            ...
            'u4_dataset' : 100,
            'u5_dataset': 3000,
            'china_xrays_dataset': 1000,
            'japan_xrays_dataset':1000,
            'montgomery_xrays_dataset': 3000,
            'nih_xrays_dataset': 1000,
